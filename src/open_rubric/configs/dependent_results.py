...
def format_dependent_results(dependent_results: dict[str, AggregatedQueryConfig], include_internals: bool = False) -> str:
    """
...
def _format_explanation_dict(explanation_dict: dict, section_name: str = "", indent_level: int = 0) -> str:
    """
